...
public class ReflectionDemo2 {
	...
	public static void main(String[] args)throws Exception 
	{
		...
		Demo demo=(Demo)Class.forName("june.Demo").newInstance();//dynamic
		System.out.println(demo);
		
		demo=(Demo)Class.forName("june.Demo").getConstructor().newInstance();
		
		System.out.println(demo);
		
		demo=(Demo)Class.forName("june.Demo").getConstructor(String.class,int.class).newInstance("hello",100);
		System.out.println(demo);
